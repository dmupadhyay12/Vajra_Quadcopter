...
uint16_t pwm_update_percentage(actuator_config_t *pwm, uint8_t pwm_update_percentage) {
    ...
    uint16_t ccr_value = (uint16_t)(MAX_PULSE_TICKS - MIN_PULSE_TICKS) * (pwm_update_percentage / 100.0) + MIN_PULSE_TICKS;
